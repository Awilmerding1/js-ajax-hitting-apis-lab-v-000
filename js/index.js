...
function displayRepositories() {
  ...
  let repoList = `<ul>${repos.map(r => '<li>' + r.name + ` - <a href="${r.html_url}">${r.html_url}</a>` + ' - <a href="#" data-repo="' +  r.name +'" onclick="getCommits(this)">Get Commits</a> '+ ' - <a href="#" data-repo="' +  r.name +'" onclick="getCommits(this)">Get Commits</a>' + + '</li>').join('')}</ul>`;
